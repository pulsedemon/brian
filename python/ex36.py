...
On a table in front of you is two weapons.
An Axe and a Dagger.\n
Which do you take?"""
...
def two_left_door(weapon, health):
    ...
    if left_chest:
        ...
        print "Do you want to OPEN it? Or EXIT room?"
    else:
        print "There is an already opened Chest"
        print "EXIT?"

    while True:
        left_input = raw_input("< ").lower()
...
def two_middle_door(weapon, health):
    ...
    if medusa:
        ...
        print "In the center of the room stands a %s" % enemy
